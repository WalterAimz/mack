    ...
    return(
        <div className="container mx-auto py-8 min-h-96 px-4 md:px-16 lg:px-24 ">
            ...
            <div className="flex flex-col md:flex-row justify-between space-x-10 mt-8">
                    ...
                    <div className="border p-2 mb-6">
                        ...
                        <div className={`space-y-4 ${billingToggle ? "" : "hidden"}`}>
                            <div>
                             ...
                             <div>
                                <label className="block taxt-gray-700" >Phone</label>
                                      <input 
                                        type="text" 
                                        name="phone"
                    ...
                    <div className="border p-2 mb-6">
                        ...
                        <div className={`space-y-4 ${shippingToggle ? "" : "hidden"}`}>
                            <div>
                             ...
                             <div>
                                <label className="block taxt-gray-700" >Zip code</label>
                                      <input 
                                        type="text" 
                                        name="zip"
                                        placeholder="Enter phone #"
                    ...
                    <div className="border p-2 mb-6">
                        ...
                        <div className={`space-y-4 ${paymentToggle ? "" : "hidden"}`}>
                            ...
                            <div className="flex items-center mb-2">
                                ...
                                />
                                <label className="block text-gray-700 ml-2" >Mobile Money</label>
                            </div>
                           {paymentMethod == "dc" && (
                ...
                <div className="md:w-1/3 bg-gray-300 p-6 rounded-lg shadow-md border">
